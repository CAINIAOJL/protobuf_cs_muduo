...
const uint32_t TableStruct_rpc_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::network::RpcMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::network::RpcMessage, _impl_.type_),
  PROTOBUF_FIELD_OFFSET(::network::RpcMessage, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::network::RpcMessage, _impl_.service_),
  PROTOBUF_FIELD_OFFSET(::network::RpcMessage, _impl_.method_),
  PROTOBUF_FIELD_OFFSET(::network::RpcMessage, _impl_.request_),
  PROTOBUF_FIELD_OFFSET(::network::RpcMessage, _impl_.response_),
  PROTOBUF_FIELD_OFFSET(::network::RpcMessage, _impl_.error_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::network::RpcMessage)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::network::_RpcMessage_default_instance_._instance,
};

const char descriptor_table_protodef_rpc_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\trpc.proto\022\007network\"\243\001\n\nRpcMessage\022\"\n\004t"
  "ype\030\001 \001(\0162\024.network.MessageType\022\n\n\002id\030\002 "
...
RpcMessage::RpcMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:network.RpcMessage)
}
RpcMessage::RpcMessage(const RpcMessage& from)
  ...
  // @@protoc_insertion_point(copy_constructor:network.RpcMessage)
}
...
RpcMessage::~RpcMessage() {
  // @@protoc_insertion_point(destructor:network.RpcMessage)
...
// @@protoc_insertion_point(message_clear_start:network.RpcMessage)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_type(static_cast<::network::MessageType>(val));
        } else
          goto handle_unusual;
        continue;
      // int64 id = 2;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "network.RpcMessage.service"));
        } else
          goto handle_unusual;
        continue;
      // string method = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "network.RpcMessage.method"));
        } else
          goto handle_unusual;
        continue;
      // bytes request = 5;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_error(static_cast<::network::ErrorCode>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* RpcMessage::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:network.RpcMessage)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:network.RpcMessage)
  return target;
}

size_t RpcMessage::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:network.RpcMessage)
  size_t total_size = 0;
...
void RpcMessage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:network.RpcMessage)
...
// @@protoc_insertion_point(class_specific_copy_from_start:network.RpcMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::network::RpcMessage*
Arena::CreateMaybeMessage< ::network::RpcMessage >(Arena* arena) {
  return Arena::CreateMessageInternal< ::network::RpcMessage >(arena);
}
